...
app = Flask(__name__)
app.secret_key = 'docker2gcp-a725567a820e.json'  # Change this to a random secret key

# SQL Server connection details
server = os.getenv('DB_SERVER', '34.139.208.194,1433')  # IP of Cloud SQL instance with port
database = os.getenv('DB_NAME', 'mydb')  # Database name
username = os.getenv('DB_USER', 'sqlserver')  # SQL Server username
password = os.getenv('DB_PASSWORD', 'Karthik@98')  # SQL Server password
